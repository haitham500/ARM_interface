...
static void MAFIO_voidSelectPortEXTICR1(PORT_T MAFIO_portPORTID,MAFIO_EXTICR1_BITS_T MAFIO_BIT0,MAFIO_EXTICR1_BITS_T MAFIO_BIT1,MAFIO_EXTICR1_BITS_T MAFIO_BIT2,MAFIO_EXTICR1_BITS_T MAFIO_BIT3)
{
...
static void MAFIO_voidSelectPortEXTICR2(PORT_T MAFIO_portPORTID,MAFIO_EXTICR2_BITS_T MAFIO_BIT0,MAFIO_EXTICR2_BITS_T MAFIO_BIT1,MAFIO_EXTICR2_BITS_T MAFIO_BIT2,MAFIO_EXTICR2_BITS_T MAFIO_BIT3)
{
switch (MAFIO_portPORTID)
{
  case PORTA:
...
static void MAFIO_voidSelectPortEXTICR3(PORT_T MAFIO_portPORTID,MAFIO_EXTICR3_BITS_T MAFIO_BIT0,MAFIO_EXTICR3_BITS_T MAFIO_BIT1,MAFIO_EXTICR3_BITS_T MAFIO_BIT2,MAFIO_EXTICR3_BITS_T MAFIO_BIT3)
{
switch (MAFIO_portPORTID)
{
  case PORTA:
...
static void MAFIO_voidSelectPortEXTICR4(PORT_T MAFIO_portPORTID,MAFIO_EXTICR4_BITS_T MAFIO_BIT0,MAFIO_EXTICR4_BITS_T MAFIO_BIT1,MAFIO_EXTICR4_BITS_T MAFIO_BIT2,MAFIO_EXTICR4_BITS_T MAFIO_BIT3)
{
switch (MAFIO_portPORTID)
{
  case PORTA:
...
static void MAFIO_voidSelectPortEVOUT(PORT_T MAFIO_portPORTID)
{
  switch (MAFIO_portPORTID)
  {
    case PORTA:
...
static void MAFIO_voidSelectPinEVOUT(PIN_T MAFIO_pinPINID)
{
  switch (MAFIO_pinPINID)
  {
    case PIN0:
...
{
  SET_BIT(MAFIO->MAFIO_MAPR,SPI1_REMAP_MAPR);
}
